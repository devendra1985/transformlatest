...
public final class VisaPayoutMappingSupport {
  ...
  public static Double transactionAmount(CjsonPayoutRequest request) {
    if (request == null) {
      return null;
    }
    if (request.getPymtAmt() != null) {
      return request.getPymtAmt();
    }
    if (request.getCrPymtAmt() != null) {
      return request.getCrPymtAmt().doubleValue();
    }
    return null;
  }
  ...
  public static Double transactionAmountFromCanonical(CanonicalTransaction tx) {
    ...
    Double transaction = toMoney(tx.getTransactionAmount());
    if (transaction != null) {
      return transaction;
    }
    return toMoney(tx.getSettlementAmount());
  }

  @Named("transactionCurrencyCode")
  public static String transactionCurrencyCode(CjsonPayoutRequest request) {
    if (request == null) {
      return null;
    }
    return firstNonBlank(request.getPymtAmtCcy(), request.getCrPymtAmtCcy());
  }
  ...
  public static String transactionCurrencyCodeFromCanonical(CanonicalTransaction tx) {
    ...
    return tx.getTransactionCurrencyCode();
  }

  @Named("settlementCurrencyCode")
  public static String settlementCurrencyCode(CjsonPayoutRequest request) {
    if (request == null) {
      return null;
    }
    return firstNonBlank(request.getCdtrAcctCcy(), request.getCrAcctCcy());
  ...
  public static String settlementCurrencyCodeFromCanonical(CanonicalTransaction tx) {
    ...
    return tx.getSettlementCurrencyCode();
  }
