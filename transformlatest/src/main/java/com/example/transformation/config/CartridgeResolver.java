...
public class CartridgeResolver {
    ...
    public ResolvedCartridgeContext resolve(
        ...
        String cacheKey = cacheKey(cartridgeId, currency, templateId, direction).intern();
        return contextCache.computeIfAbsent(cacheKey, k -> doResolve(cartridgeId, currency, templateId, direction));
    }
    ...
    public ResolvedCartridgeContext resolve(String cartridgeId, String currency) {
        return resolve(cartridgeId, currency, null, DEFAULT_DIRECTION);
    }

    public ResolvedCartridgeContext resolve(String cartridgeId, String currency, String direction) {
        return resolve(cartridgeId, currency, null, direction);
    }

    private ResolvedCartridgeContext doResolve(
            String cartridgeId,
            String currency,
            String templateId,
            String direction) {
