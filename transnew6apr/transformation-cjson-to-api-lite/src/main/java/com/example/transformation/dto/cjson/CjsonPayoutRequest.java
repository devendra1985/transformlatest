...
public class CjsonPayoutRequest {
  ...
  public String getCartridgeCode() {
    return txInfValue(TxInf::getCartridgeCode);
  }

  @JsonIgnore
  public String getApiType() {
    return txInfValue(TxInf::getApiType);
  }

  @JsonIgnore
  public String getSchemaType() {
    return txInfValue(TxInf::getSchemaType);
  }
  ...
  private <T> T txInfValue(java.util.function.Function<TxInf, T> getter) {
    ...
    return getter.apply(paymentData.getTxInf().get(0));
  }
