...
/**
 * Indicates the current status of the currency. Only two values are allowed &lt;br /&gt; ENABLED – payouts in this currency are allowed. &lt;br /&gt; DISABLED – payouts in this currency are not allowed. 
 */
