 ...
 */
@JsonPropertyOrder({
  FieldValue.JSON_PROPERTY_LABEL,
  FieldValue.JSON_PROPERTY_OPTION
})
...
public class FieldValue {
  ...
  public FieldValue label(String label) {
    this.label = label;
    return this;
  }
  ...
  public FieldValue option(String option) {
    this.option = option;
    return this;
  }
  ...
  /**
   * Return true if this FieldValue object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.label, fieldValue.label) &&
        Objects.equals(this.option, fieldValue.option);
  }

  @Override
  public int hashCode() {
    return Objects.hash(label, option);
  }
